...
Then you'll need to fill the database with data, you can do this by running this command: flask --app WASPGpt fill-db (This checks the for the data in the database folder.)
